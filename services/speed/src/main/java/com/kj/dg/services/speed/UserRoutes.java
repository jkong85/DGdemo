...
import com.kj.dg.services.speed.UserRegistryActor.User;
import com.kj.dg.services.speed.UserRegistryMessages.ActionPerformed;
import com.kj.dg.services.speed.UserRegistryMessages.CreateUser;
                                ...
                                entity(
                                        ...
                                        user -> {
                                            ...
                                            return onSuccess(() -> userCreated,
                                                    performed -> {
                                                        //log.info("Update Speed [{}]: {}", user.getName(), performed.getDescription());
                                                        log.info("Update Speed [{}]", user.getAge());
